...
export const ADVANTAGE_ITEMS: AdvantageItemData[] = [
  {
    ...
    title: 'Приватность',
    description:
      'Капитальные стены с утеплителем и жесткой обшивкой позволяют полноценно уединиться в собственном номере, внутри не слышно соседей, соседи не слышат, что происходит внутри.',
    iconSrc: privacyIcon,
    hasIconFrame: true,
  },
  {
  ...
  },
  {
    ...
    title: 'Долговечность',
    description:
      'Срок службы 25-50 лет в зависимости от условий и качества ухода за куполом. ПВХ-тент на солнце деградирует за 5 лет, а через 3 года теряет цвет и блеск.',
